...
dash.register_page(__name__,name = 'MATCH 46 IND VS NZ ')
        ...
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.Br(),
                    html.H1('SEMI FINAL 1', style={'textAlign':'center'}),
                    html.Br(),
                    html.Br(),
                    ...
                    html.H4(str((68.4332)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((59.5642)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((67.4653)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((61.083)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((20.1561)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((83.4395)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
