...
dash.register_page(__name__,name = 'MATCH 48 IND VS AUS')
        ...
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.Br(),
                    html.H1('ODI WORLD CUP 2023 FINALS', style={'textAlign':'center'}),
                    html.Br(),
                    ...
                    html.H4(str((65.9389)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((65.8539)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((64.4008)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((67.6916)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((85.4845)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((65.7156)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
