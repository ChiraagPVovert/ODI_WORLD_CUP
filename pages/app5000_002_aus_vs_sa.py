...
dash.register_page(__name__,name = 'MATCH 47 AUS VS SA ')
        ...
        [
            ...
            dbc.Col(
                [
                    html.Br(),
                    html.Br(),
                    html.H1('SEMI FINAL 2', style={'textAlign':'center'}),
                    html.Br(),
                    html.Br(),
                    ...
                    html.H4(str((52.5331)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((62.6862)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((50.9019)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((64.3398)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((84.6543)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    ...
                    html.H4(str((44.4323)) + " %", style={'textAlign': 'center'}),
                    html.Br(),
                    html.Br(),
